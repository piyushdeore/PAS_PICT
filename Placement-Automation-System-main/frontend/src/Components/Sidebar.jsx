    ...
    return (
      <div className='navbar-container'>
        ...
        <div className="side-menu" style={{height:'60%',color:'gray',width:'100%',display:'flex',flexDirection:'column',alignItems:'center'}}>
            ...
            <Link style={{width:'70%',textDecoration:'none',color:'inherit'}} to="/student/under-construction"><Button style={{width:'100%'}} onClick = {()=> this.setState({active:4})} className={`menu--item ${this.state.active===4 ? "active" : ""}`}>Schedule</Button></Link>
