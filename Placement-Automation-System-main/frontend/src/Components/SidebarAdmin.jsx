    ...
    return (
      <div className='navbar-container'>
        ...
        <div className="side-menu" style={{height:'60%',color:'gray',width:'100%',display:'flex',flexDirection:'column',alignItems:'center'}}>
            ...
            <Link style={{width:'70%',textDecoration:'none',color:'inherit'}} to="/admin"><Button style={{width:'100%'}} onClick = {()=> this.setState({active:3})} className={"menu-item"+(this.state.active===3?"-active":"")}>Edit Job Details</Button></Link>
            ...
            <Link style={{width:'70%',textDecoration:'none',color:'inherit'}} to="/admin"><Button style={{width:'100%'}} onClick = {()=> this.setState({active:5})} className={"menu-item"+(this.state.active===5?"-active":"")}>Placement Statistics</Button></Link>
            <Link style={{width:'70%',textDecoration:'none',color:'inherit'}} to="/admin"><Button style={{width:'100%'}} onClick = {()=> this.setState({active:5})} className={"menu-item"+(this.state.active===5?"-active":"")}>Schedule</Button></Link>
